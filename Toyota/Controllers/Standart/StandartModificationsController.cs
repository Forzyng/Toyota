...
namespace Toyota.Controllers.Standart
{
    public class StandartModificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Slug,Name,ImgUrl,ModelId")] Modification modification, IFormFile fileToStorage)
        {
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            ViewBag.Color = new SelectList(_context.Colors, "Id", "Name");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Slug,Name,ImgUrl,ModelId")] Modification modification, IFormFile fileToStorage)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    modification.ImgUrl = await Helpers.Media.UploadImage(fileToStorage, "modification_colors_thumbs");
